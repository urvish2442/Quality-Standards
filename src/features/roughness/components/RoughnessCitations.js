...
import { ROUGHNESS_CITATIONS } from "@/features/roughness/constants/roughnessData";

const RoughnessCitations = () => {
  return (
      ...
      <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-5 py-4 sm:px-6 [&::-webkit-details-marker]:hidden">
        <div>
          ...
          <p className="text-muted mt-0.5 text-sm">
            Standards used for surface texture parameters and indication
          </p>
        </div>
        <ChevronDown
...
export default RoughnessCitations;

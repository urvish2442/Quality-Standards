    ...
    <div className="flex flex-col gap-6">
      <section className="border-border bg-surface rounded-2xl border p-5 shadow-(--card-shadow) sm:p-6">
        ...
        <p className="text-muted mt-2 max-w-3xl text-sm">
          Enter any valid combination (SSS, SAS, ASA/AAS, or SSA). Results
          update live on the triangle diagram.
        </p>
      </section>
        ...
        <div className="border-border bg-surface rounded-2xl border p-5 shadow-(--card-shadow) sm:p-6">
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              type="button"
              onClick={clearFields}
              className="border-border bg-background text-muted hover:bg-primary-soft hover:text-foreground rounded-xl border px-3 py-1.5 text-sm font-medium transition"
            >
              Clear
            </button>
          </div>
